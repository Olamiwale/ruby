              ...
              {user ? (
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="hidden md:block text-xs text-gray-500 hover:text-[#7a0d20] transition-colors" >
                    Log Out
                  </button>
                </div>
              ) : (
...
//               {!toggle ? <FaBars onClick={nav} size={20} /> : <FaXmark onClick={nav} size={12} />}
//             </div>
...
//         {/* Mobile menu */}
//         {toggle && (
//           <ul className="font-semibold absolute h-screen cursor-pointer z-50 bg-slate-200 w-[150px] px-10 space-y-8 pt-[50px] left-0">
